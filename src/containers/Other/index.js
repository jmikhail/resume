    ...
    return (
        <Element name='other' className="other-container">
            <Element name='publications'>
                ...
                <p className="other-content">Misagh Tavanpour, <span class="highlight">Jan Mikhail</span>, Gabriel A. Wainer, Gary Boudreau, "The Case For DEVS In Networking M&S: Upload User Collaboration In Mobile Networks Using Coordinated Multipoint", Proceedings of SpringSim (TMS/DEVS 2017), April 2015, Virginia Beach, VA, USA. <a class="highlighted-link" href="http://cell-devs.sce.carleton.ca/publications/2017/TMWB17/THE%20CASE%20FOR%20DEVS%20IN%20NETWORKING%20M&S:%20UPLOAD%20USER%20COLLABORATION%20IN%20MOBILE%20NETWORKS%20USING%20COORDINATED%20MULTIPOINT.pdf">read</a></p>
